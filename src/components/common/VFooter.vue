    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <!-- <div>
          ...
          <ul class="space-y-2">
            <li>
              <a href="#" class="text-text-secondary hover:text-text-primary transition-colors text-sm"
                >Pricing</a
              >
            </li>
            <li>
        ...
        <!-- Legal -->
        <!-- <div>
          <h4 class="style="color: var(--color-text-primary);" font-semibold mb-4">Legal</h4>
          <ul class="space-y-2">
            <li>
              <a href="#" class="text-text-secondary hover:text-text-primary transition-colors text-sm"
                >Privacy Policy</a
      ...
      <div class="mt-8 flex flex-col sm:flex-row justify-between items-center">
        <p class="text-sm text-text-secondary">
          © 2025 {{ APP_NAME }}. {{ t('footer.copyright') }}
        </p>
        <div class="flex items-center gap-4 mt-4 sm:mt-0">
          ...
          <a
            href="https://www.facebook.com/huyV81"
            target="_blank"
            class="text-text-secondary hover:text-text-primary transition-colors"
          >
            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
