...
const isFormValid = computed(() => {
  return form.email && form.password && !error.email && !error.password
})
        ...
        <div class="flex flex-col flex-1 w-full lg:w-1/2">
          <div class="w-full max-w-md pt-10 mx-auto">
            ...
            >
              ...
              <span class="ml-3">{{ t('auth.login.back') }}</span>
            </router-link>
          </div>
          <div class="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
            <div>
              <div class="mb-5 sm:mb-8">
                <h1
                  class="mb-2 font-semibold text-white/90 text-title-sm sm:text-title-md text-2xl"
                >
                  {{ t('auth.login.title') }}
                </h1>
                <p class="text-sm text-gray-400">{{ t('auth.login.description') }}</p>
              </div>
              <div>
                  ...
                  <div class="space-y-5">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        class="h-11 w-full rounded-lg border bg-transparent px-4 py-2.5 text-sm shadow-theme-xs placeholder:text-gray-400 border-gray-700 focus:border-brand-300 focus:outline-hidden focus:ring-1 text-white"
                    ...
                    <div>
                      ...
                      <div class="relative">
                        ...
                        <span
                          ...
                          class="absolute z-30 text-gray-400 -translate-y-1/2 cursor-pointer right-4 top-1/2"
                        >
                          <Icon
                            v-if="!showPassword"
                      ...
                      <p v-if="error.password" class="text-sm text-red-400 mt-1">
                        {{ error.password }}
                      </p>
                    </div>
                    <!-- Checkbox -->
                    <div class="flex items-center justify-between">
                      ...
                      <router-link
                        to="/reset-password"
                        class="text-sm text-brand-400 hover:text-brand-600"
                    ...
                    <div>
                      <button
                        ...
                        class="flex items-center justify-center w-full px-4 py-3 text-sm font-medium text-white transition rounded-lg bg-[#465fff] shadow-theme-xs hover:bg-[#3641f5] disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
                      >
                ...
                <div class="mt-5">
                  <p class="text-sm font-normal text-center text-gray-400 sm:text-start">
                    ...
                    <router-link to="/signup" class="text-brand-400 hover:text-brand-600">{{
                      t('auth.login.signUp')
                    }}</router-link>
                  </p>
                </div>
